    ...
    <div className="col-2 col-sm-3 col-xl-2 bg-dark text-white d-flex flex-column min-vh-100">
      <div className="container py-2">
        ...
        <nav className="nav flex-column mt-3">
          ...
          <Link className="nav-link text-white" to="/Panier">
            <svg
              xmlns="http://www.w3.org/2000/svg"
              width="16"
              height="16"
            ...
            <span className="d-none d-sm-inline ms-2">Panier</span>
          </Link>

          <Link className="nav-link text-white" to="/Securite">
            <svg
              xmlns="http://www.w3.org/2000/svg"
              width="16"
              height="16"
            ...
            <span className="d-none d-sm-inline ms-2">Securite</span>
          </Link>
      ...
      <div className="mt-auto px-3 pb-3">
        <nav className="nav flex-column">
          <Link className="nav-link text-white" to="/">
            ...
            <span className="d-none d-sm-inline ms-2 fs-6">Exit</span>
          </Link>
        </nav>
      </div>
    </div>
